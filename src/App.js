      ...
      <div className="container clearfix">
          ...
          <div className="chat" style={{marginLeft:'600px'}}>
            <div className="chat-header clearfix">
              ...
              <div className="chat-about">
                <div className="chat-with">Friend's Wallet &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Balance Amount :</div>
               
               <div className="chat-with" style={{marginLeft: '280px', marginTop:'-19px', fontSize:'28px'}}>   ₹ {FriendBlance}</div>
        ...
        <div className="chat" style={{marginTop:'-661.5px'}}>
          <div className="chat-header clearfix">
            ...
            <div className="chat-about">
            <div className="chat-with">My Wallet &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Balance Amount :</div>
               
               <div className="chat-with" style={{marginLeft: '280px', marginTop:'-19px', fontSize:'28px'}}>   ₹ {MyBalance}</div>
